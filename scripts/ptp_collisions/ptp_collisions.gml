...
function scr_solid(arg0, arg1, arg2 = [obj_solid, obj_slope, obj_slopePlatform, obj_platform, obj_oneWayWall])
{
    ...
    x = arg0;
    y = arg1;
    var num = instance_place_list(x, y, arg2, il, true);
    var _collided = false;
...
function scr_destroy_horizontal(arg0, arg1 = [par_destructible, obj_destroyablecheckpoint])
{
    static il = global.instancelist;
    ...
    if (arg0 != 0)
    {
        var _num = instance_place_list(x + arg0, y, arg1, il, false);
...
function scr_destroy_vertical(arg0, arg1 = [par_destructible, obj_destroyablecheckpoint])
{
    static il = global.instancelist;
    ...
    if (arg0 != 0)
    {
        var _num = instance_place_list(x, y + arg0, arg1, il, false);
...
function scr_destroybounce(arg0, arg1 = par_bouncysolid)
{
    static il = global.instancelist;
...
function scr_collide_destructibles(arg0, arg1)
{
    if (triggerNitros)
    {
        if (object_index == obj_player)
        {
            ...
            {
                scr_destroy_horizontal(arg0, obj_destroyablenitro);
                var _destroyed = scr_destroy_vertical(arg1, obj_destroyablenitro);
        ...
        {
            scr_destroy_horizontal(arg0, obj_destroyablenitro);
            scr_destroy_vertical(arg1, obj_destroyablenitro);
        }
    }
    
    if (collide_destructibles != -1)
        collide_destructibles(arg0, arg1);
}

function fire_ray(arg0, arg1, arg2, arg3, arg4 = 1, arg5 = [obj_solid, obj_slope, obj_slopePlatform, obj_platform, obj_oneWayWall], arg6 = spr_PTPpixel)
{
    ...
    if (_dist > 0)
    {
        for (var i = 0; i < _dist; i += arg4)
        {
            ...
            if (scr_solid(x + sign(lengthdir_x(1, _dir)), y + sign(lengthdir_y(1, _dir)), arg5))
            {
...
function fast_ray(arg0, arg1, arg2, arg3, arg4 = [obj_solid, obj_slope, obj_slopePlatform, obj_platform])
{
    ...
    if (floor(arg0) == floor(arg2))
        _num = collision_line_list(arg0, arg1, arg2, arg3, arg4, false, true, _il, true);
    else
        _num = collision_rectangle_list(arg0, arg1, arg2, arg3, arg4, false, true, _il, true);
    ...
    for (var _i = 0; _i < _num; _i++)
    {
        ...
        if (_up)
            _sidecheck = (sign(_instance.image_yscale) > 0) ? (_y <= arg1) : (_y >= arg1);
        else
            _sidecheck = (sign(_instance.image_yscale) > 0) ? (_y >= arg1) : (_y <= arg1);
        
        if (_instance.canCollide != -1 && !_instance.canCollide(id, arg0, arg1))
            continue;
