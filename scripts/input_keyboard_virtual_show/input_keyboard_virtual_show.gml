function input_keyboard_virtual_show(arg0 = 0)
{
    ...
    if (_global.__using_steamworks)
    {
        ...
        {
            case 3:
                arg0 = steam_floating_gamepad_text_input_mode_email;
                break;
            
            case 4:
                arg0 = steam_floating_gamepad_text_input_mode_numeric;
                break;
            
            default:
                arg0 = steam_floating_gamepad_text_input_mode_single_line;
                break;
        }
