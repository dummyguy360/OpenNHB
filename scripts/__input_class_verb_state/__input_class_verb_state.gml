function __input_class_verb_state() constructor
{
    ...
    static __tick = function(arg0, arg1)
    {
        ...
        if (__global.__toggle_momentary_state && __type == UnknownEnum.Value_0 && variable_struct_exists(__global.__toggle_momentary_dict, __name))
        {
        ...
        if (__global.__cooldown_state && __type == UnknownEnum.Value_0 && variable_struct_exists(__global.__cooldown_dict, __name))
        {
