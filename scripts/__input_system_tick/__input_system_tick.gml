function __input_system_tick()
{
    ...
    if (__input_global().__on_desktop || (false || os_type == os_gxgames))
    {
        ...
        else if (keyboard_key != vk_nokey || mouse_button != mb_none || (_global.__use_native_focus && window_has_focus()) || (os_type == os_macosx && !(false || os_type == os_gxgames) && _global.__pointer_moved))
        {
