function __input_gamepad_set_type()
{
    ...
    switch (os_type)
    {
        ...
        default:
            ...
            {
                case "3412adbe":
                    if ((__button_count == 12 || __button_count == 23) && __axis_count == 6 && __hat_count == 0 && os_type == os_windows)
                    {
                ...
                case "bc200155":
                    if (__input_string_contains(__description, "JJ", "NeoGeo G1 Pro") && __input_global().__on_desktop)
                    {
                        __input_trace("Overriding controller ", __index, " type to NeoGeo Mini");
                ...
                case "00000000":
                    if (__description == "Wireless Gamepad" && __button_count == 16 && __axis_count == 4 && __hat_count == 1 && os_type == os_windows)
                    {
